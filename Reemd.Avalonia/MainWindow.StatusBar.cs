...
public partial class MainWindow
{
    ...
    private void UpdateSavedIndicator(bool saved)
    {
        ...
        SavedIndicator.Foreground = new SolidColorBrush(saved
            ? (_isDarkMode ? Color.FromRgb(0x81, 0xC7, 0x84) : Color.FromRgb(0x2E, 0x7D, 0x32))
            : (_isDarkMode ? Color.FromRgb(0xEF, 0x9A, 0x9A) : Color.FromRgb(0xC6, 0x28, 0x28)));
    }
