...
public sealed class MarkdownConverter
{
    ...
    /// <param name="baseUrl">Optional base URL for resolving relative image paths (e.g., the markdown folder path).</param>
    public string ConvertToHtml(string markdown, double baseFontSize = 14, bool isDark = false, string? baseUrl = null)
    {
        ...
        {
            sb.AppendLine($"<base href=\"{EscapeHtmlAttr(baseUrl)}\" />");
        }
